...
export type Section8Icon4AsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Section8Icon4AsvgIcon(props: Section8Icon4AsvgIconProps) {
...
export default Section8Icon4AsvgIcon;
/* prettier-ignore-end */
