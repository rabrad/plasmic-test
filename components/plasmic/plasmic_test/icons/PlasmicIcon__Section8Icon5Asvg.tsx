...
export type Section8Icon5AsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Section8Icon5AsvgIcon(props: Section8Icon5AsvgIconProps) {
...
export default Section8Icon5AsvgIcon;
/* prettier-ignore-end */
