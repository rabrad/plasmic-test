...
export type Section8Icon6BsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Section8Icon6BsvgIcon(props: Section8Icon6BsvgIconProps) {
...
export default Section8Icon6BsvgIcon;
/* prettier-ignore-end */
